...
public class Menu {
    ...
    public Menu() {
        ...
        this.playerOptions_.add("Choose white player's type:"); // index 0
        this.playerOptions_.add("play against a human player"); // index 1
    }

    public Player getPlayerByUserChoice(ViewGame view) {

        int choice = view.presentMenu(this.playerOptions_);
